...
# значение. Путь к файлу должен передаваться в аргументах декоратора. Функция
# test_2 в коде ниже также должна отработать без ошибок.
...
def logger(path):
    ...
    def __logger(old_function):
        def new_function(*args, **kwargs):
            ...
            print(f'Возвращаемое значение функции: {result}\n')
